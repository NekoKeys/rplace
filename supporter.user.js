// ==UserScript==
// @name         CalPoly rplace autoclicker
// @namespace    http://tampermonkey.net/
// @version      0.1.1
// @description  support clicking
// @author       halfdane nekokeys
// @match        https://hot-potato.reddit.com/embed*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=reddit.com
// @grant        none
// @updateURL    https://github.com/AddisonTustin/rplace/blob/main/supporter.user.js
// @downloadURL  https://github.com/AddisonTustin/rplace/blob/main/supporter.user.js
// ==/UserScript==
...
async function run() {
    ...
    async function get_template_ctx(ml_canvas){
        return new Promise((resolve, reject) => {
            ...
            img.onerror = reject
            img.src = "https://raw.githubusercontent.com/AddisonTustin/rplace/main/cal-poly.png?tstamp=" + Math.floor(Date.now() / 10000);
        })
    }
